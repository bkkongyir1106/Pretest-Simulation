setwd("D:/OSU/Research/Pval/power/power")
set.seed(1)
alpha<-0.05
...
power
Power_exp_II<- as.data.frame(power)

#export data into excel
library("writexl")
write_xlsx(Power_exp_II,"D:/OSU/Research/Pval/power//power/Power_exp_II.xlsx")

save.image(paste0("Power_exp_II",".RData"))
