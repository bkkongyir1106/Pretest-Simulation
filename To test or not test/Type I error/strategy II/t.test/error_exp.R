...
title(main = "Type I Error Rate--strategy II -exp...t.test")
...
dev.off()
Error_exp_II<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(Error_exp_II,"D:/OSU/Research_Fall2023/type I error/t test strategy II/Error.exp_II.xlsx")
