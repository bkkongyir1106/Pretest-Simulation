...
title(main = "Type I Error Rate -Normal_t.test")
...
error.norm <- as.data.frame(pvalue)

#export data into excel
library("writexl")
write_xlsx(error.norm, "D:/OSU/Research/Pval/New folder/Error.norm.t.test.xlsx")

save.image(paste0("Error_norm",".RData"))
