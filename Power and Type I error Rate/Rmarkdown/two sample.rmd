  ...
  # ===================================================================================================
    ...
    for (k in 1:n) {
      ...
      if(t.test(contaminate1, contaminate2)$p.value <= alpha){
        ...
        if(t.test(contaminate1/2 , contaminate1/2 + d)$p.value <= alpha){
...
legend("topleft", legend=c("exponential", "uniform", "t", "chisq", "gamma", "weibull", "lognormal"),
       col=c("red","blue", "purple", "green", "pink", "brown", "yellow"), lty =1,cex = 0.5)
```
...
```{r}
#Power loss of t test
plot(Power_SW_logn,Type1Error_logn, type="l", lwd= 2, col = "red", 
     ylim = c(0, 1),xlab = "Power of SW test", ylab = "Type I error rate")

title(main = "Utility of SW test.")
```
