...
Power_SW_test<-array(data1, dim = c(5, 8), dimnames = list(sample_size,c("exp", "unif", "t", "chisq", "gamma", "weibull", "lognormal", "contaminate")))
Power_SW_test
```
...
Type1_error<-array(data2, dim = c(5, 9), dimnames = list(sample_size,c("norm", "exp", "unif", "t", "chisq", "gamma", "weibull", "lognormal", "contaminate")))
Type1_error
```
...
inflation_error<-array(data5, dim = c(5, 8), dimnames = list(sample_size,c("exp", "unif", "t", "chisq", "gamma", "weibull", "lognormal", "contaminate")))
inflation_error
```
...
Power_t_test<-array(data3, dim = c(5, 9), dimnames = list(sample_size,c("norm", "exp", "unif", "t", "chisq", "gamma", "weibull", "lognormal", "contaminate")))
Power_t_test
```
...
Powerloss_t_test<-array(data4, dim = c(5, 8), dimnames = list(sample_size,c("exp", "unif", "t", "chisq", "gamma", "weibull", "lognormal", "contaminate")))
Powerloss_t_test
```
