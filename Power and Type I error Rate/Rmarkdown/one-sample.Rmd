 ...
 for(j in 1 : N){
  ...
  # ===================================================================================================
    ...
    for (k in 1:n) {
      ...
      if(t.test(contaminate1)$p.value <= alpha){
          error_ttest_contaminate[j] <- 1
        }
        if(shapiro.test(contaminate1)$p.value <= alpha){
          PowrSW_contaminate[j] <- 1
        }
        if(t.test(contaminate1/2 + d)$p.value <= alpha){
...
plot(sample_size, powrloss_exp, type="l", lwd= 2, col = "red", 
     ylim = c(-0.4, 0.5),xlab = "Sample Size", ylab = "Power")
