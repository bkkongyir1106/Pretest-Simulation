...
```{r}
plot(density(tstat_chi[, 1]), typ = "n", xlim = c(-5, 15), ylim = c(0, 0.6), main = " ", xlab = " ")
title(main = "Exp(1)")
for (k in 1:3){
...
We see that all the  density plots of the test statistic for both the uniform and Normal distribution are right skewed with skewness increasing with the effect size. Compared to the test statistic of samples from normal distribution, the test statistic of the uniform samples has a slightly higher peak. However the peak decreases with effect sizes. The density plots are similar as effect size increases.

```{r}
plot(density(tstat_chi[, 1]), typ = "n", xlim = c(-5, 15), ylim = c(0, 0.5), main = " ", xlab = " ")
...
We see that all the  density plots of the test statistic for both the t and Normal distribution are right skewed with skewness increasing with the effect size. Compared to the test statistic of samples from normal distribution, the test statistic of the t samples has a slightly lower peak.
```{r}
plot(density(tstat_chi[, 1]), typ = "n", xlim = c(-5, 15), ylim = c(0, 0.5), main = " ", xlab = " ")
title(main = "t distribution with 3 df")
for (k in 1:3){
...
We see that all the  density plots of the test statistic for both the Gamma and Normal distribution are right skewed with skewness increasing with the effect size. Compared to the test statistic of samples from normal distribution, the test statistic of the Gamma samples has a slightly higher peak. However the peak decreases with effect sizes.
```{r}
...
We see that all the  density plots of the test statistic for both the Lognormal and Normal distribution are right skewed with skewness increasing with the effect size. Compared to the test statistic of samples from normal distribution, the test statistic of the Lognormal samples has a higher higher peak for smaller effect size but decreases with increase in effect size. The density plots are similar as effect size increases.
```{r}
plot(density(tstat_chi[, 1]), typ = "n", xlim = c(-5, 15), ylim = c(0, 0.7), main = " ", xlab = " ")
