...
source("~/Desktop/OSU/Research/Pretest-Simulation/User_framework/two sample results/general_two_function_test_functions.R")

setwd("~/Desktop/OSU/Research/Pretest-Simulation/User_framework/two sample results")
