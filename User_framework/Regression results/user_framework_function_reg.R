...
source("~/Desktop/OSU/Research/Pretest-Simulation/User_framework/Regression results/function_for_regression_test.R")

setwd("~/Desktop/OSU/Research/Pretest-Simulation/User_framework/Regression results")
...
# Generate all plots
pdf("reg_test_tradeoff.pdf", width=12, height=8)
...
pdf("reg_test_EPL_vs_EPG.pdf", width=12, height=8)
...
pdf("reg_test_power_error.pdf", width=12, height=6)
...
save.image(paste0("reg_test_results_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".RData"))
