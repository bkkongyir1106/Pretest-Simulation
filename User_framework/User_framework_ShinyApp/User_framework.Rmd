...
```{r setup, include=FALSE, warning=FALSE, cache.comments=FALSE, message=FALSE}
...
### ROC for Normality test Methods
```{r}
# --------------- Run the simulation -------------------
roc_pval_ds_test <- fn_for_roc_curve_for_norm_test(
  n = 10,
  alpha_pretest = seq(from = 0.001, to = 1, by = 0.05),
  H1_dist = "Exponential",
...
# create roc like curve of power vs Type I error
...
```{r , fig.height = 5, fig.width = 8}
# create roc like curve of expected power loss and expected Type I error
...
```{r}
# load user defined functions
FilePath <- "~/Desktop/OSU/Research/Research/user_framework/ShinyApp/sample_test_functions/anova_functions/"
source(paste0(FilePath, "gen_data.R"))
source(paste0(FilePath, "get_parameters.R"))
source(paste0(FilePath, "fn_get_norm_obj.R"))
source(paste0(FilePath, "fn_for_ds_test_1.R"))
...
```{r}
# load user defined functions
FilePath <- "~/Desktop/OSU/Research/Research/user_framework/ShinyApp/sample_test_functions/regression_functions/"
source(paste0(FilePath, "gen_data.R"))
source(paste0(FilePath, "get_parameters.R"))
source(paste0(FilePath, "fn_get_norm_obj.R"))
source(paste0(FilePath, "fn_for_ds_test_1.R"))
