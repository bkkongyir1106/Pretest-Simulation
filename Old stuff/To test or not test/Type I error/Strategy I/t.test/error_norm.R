setwd("D:/OSU/Research_Fall2023/type I error")
set.seed(1)
alpha<-0.05
N<-10000
...
Error_norm_I<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(Error_norm_I,"D:/OSU/Research_Fall2023/type I error/t test strategy I/Error.Normal_I.xlsx")

save.image(paste0("Normal.I_test",".RData"))
