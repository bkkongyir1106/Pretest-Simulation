...
title(main = "Type I Error Rate--strategy II -unif...t.test")
...
legend("topleft", legend=c("0.100", "0.050", '0.010',"0.005","w/o s-w test"),
       col=c("black","red","blue", "green", "orange"), lty =c(1:5),cex = 0.85)
dev.off()
Error_unif_II<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(Error_unif_II,"D:/OSU/Research_Fall2023/type I error/t test strategy II/Error.unif_II.xlsx")

save.image(paste0("unif.II_test",".RData"))
