...
legend("topright", legend=c("Laplace", "Normal", "t", "Contaminated"), lwd = 3,
       col=c( "red", "blue", "green", "orange"), lty =c(1, 2, 3, 4), pch = c(1, 2, 8),cex = 0.8, title = "Distribution")

```

### Power of two-stage procedure

```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Expected Power loss and Expected Inflation of Type I error/ONE SAMPLE/OneSampleOverallPower20240607.RData")
#Probability of SW test
...
```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Expected Power loss and Expected Inflation of Type I error/ONE SAMPLE/ONESAMPLE_EXPECTED_TYPE1_ERROR.RData")
#Probability of SW test
nvec = nvec[-1]
data_prob_SW <-data.frame(prob.non.sig.SW.test_par)[-1,]
# power loss
...
### Type I error rate two-stage procedure


```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Expected Power loss and Expected Inflation of Type I error/ONE SAMPLE/ONESAMPLE.OVERALL.TYPI.ERROR..RData")
#Probability of SW test
...
plot(nvec, TypeI.error.t.test$Exponential,  type = "o", lty = 1, pch = 1, col = "red", lwd = 3, 
     ylim = c(0, 0.8), xlim = range(nvec), xlab = "Sample Size", ylab = "Type I error")
...
plot(nvec, TypeI.error.t.test$Laplace, type = "o", lty = 1, pch = 1, col = "red", lwd = 3, 
     ylim = c(0, 0.1), xlim = range(nvec), xlab = "Sample Size", ylab = "Type I error rate")
...
plot(nvec, TypeI.error.U.test$Exponential,  type = "o", lty = 1, pch = 1, col = "red", lwd = 3, 
     ylim = c(0, 0.5), xlim = range(nvec), xlab = "Sample Size", ylab = "Expected Inflation of Type I error")
...
plot(nvec, TypeI.error.U.test$Laplace, type = "o", lty = 1, pch = 1, col = "red", lwd = 3, 
     ylim = c(0, 0.1), xlim = range(nvec), xlab = "Sample Size", ylab = "Type I error")
...
plot(nvec, overall_TypeI.error$Exponential,  type = "o", lty = 1, pch = 1, col = "red", lwd = 3, 
     ylim = c(0, 0.5), xlim = range(nvec), xlab = "Sample Size", ylab = "EType I error")
