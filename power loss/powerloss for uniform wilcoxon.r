...
power_loss
png(file="unif_U.test_powerloss.jpeg", width=600, height=600)
plot(effect_size, power_loss[1,], type="l", col = "black", 
     ylim = c(0, 1.0),xlab = "effect Size", ylab = "Power loss")
...
title(main = "Power loss under U test for uniform dist.")
