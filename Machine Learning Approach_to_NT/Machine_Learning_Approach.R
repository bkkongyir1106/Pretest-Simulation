...
# compare models through ROC curves
...
# generate plots
pdf("roc_curve.pdf", width=5, height=5)
...
test_sample <- gen_data(n = sample_size, dist = "t")
...
prop_non_normal <- mean(classification_results$Prediction == "Non_Normal")
decision_threshold <- 0.60
final_prediction <- ifelse(prop_non_normal >= decision_threshold, "Non_Normal", "Normal")

cat("\nProportion Non_Normal:", round(prop_non_normal, 3),
