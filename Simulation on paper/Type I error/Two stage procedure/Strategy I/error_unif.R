...
title(main = "Type I Error Rate for two stage under strategy I unif dist")
...
error_unif_two_stage_I<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(error_unif_two_stage_I,"D:/OSU/Research_Fall2023/two stage strategy I/error_unif_two_stage_I.xlsx")

save.image(paste0("error_unif_two_stage_I",".RData"))
