setwd("D:/OSU/Research_Fall2023/type I error/u test strategy I")
set.seed(1)
alpha<-0.05
N<-10000
...
for( i in 1 : length(sample_size)){
  ...
  for( j in 1 : length(shapiro_alpha)){
    ...
    error[i,j]<- round(W_reject_h0/N, 3)
  }
}
error
...
title(main = "Type I Error Rate--strategy II -Normal...wilcoxon test")
...
Error_norm_t.test_I<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(Error_norm_t.test_I,"D:/OSU/Research_Fall2023/type I error/u test strategy I/Error_norm_t.test_I.xlsx")

save.image(paste0("Error_norm_t.test_I",".RData"))
