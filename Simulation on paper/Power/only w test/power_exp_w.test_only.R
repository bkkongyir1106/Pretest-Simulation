...
exp_power_w.test_only<- as.data.frame(power_w.test)

#export data into excel
library("writexl")
write_xlsx(exp_power_w.test_only,"D:/OSU/Research/Pval/power/exp_power_w.test_only.xlsx")

save.image(paste0("exp_power_w.test_only",".RData"))
