...
title(main = "Type I Error Rate -Normal...t.test")
...
Error_strategy2.norm<- as.data.frame(pvalue)

#export data into excel
library("writexl")
write_xlsx(Error_strategy2.norm,"C:/Users/bkongyi/OneDrive - Oklahoma A and M System/Research/Error.Normal_II.xlsx")
