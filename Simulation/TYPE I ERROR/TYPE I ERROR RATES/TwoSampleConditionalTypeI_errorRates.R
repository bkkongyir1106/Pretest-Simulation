...
## Set up the simulation parameters
{
  ...
  #dist_sum <- c("Standard Normal",  "t" , "Contaminated", "Laplace","Exponential", "Chi-Square",  "LogNormal")
...
system.time({
  ...
  TypeI.errorRate <- array(errorvec, dim = c(length(nvec), length(dist_sum)), dimnames = list(nvec, dist_sum))
