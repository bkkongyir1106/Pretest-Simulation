...
### Predict samples of size 10 from Chi-squared distribution
```{r}
# ------------------------------------------------
# Example Usage for Single Dataset Prediction
# ------------------------------------------------
file_path <- "~/Desktop/OSU/Research/Pretest-Simulation/Simulation/MACHINE LEARNING APPROACH/data/chisquared_10.csv"
...
### Predict samples of size 10 from Normal distribution
```{r}
# ------------------------------------------------
# Example Usage for Single Dataset Prediction
# ------------------------------------------------
file_path <- "~/Desktop/OSU/Research/Pretest-Simulation/Simulation/MACHINE LEARNING APPROACH/data/normal_10.csv"
single_predictions <- predict_single_dataset(
                                    file_path = file_path,
                                    trained_models = models_list,
                                    preProcStandard = norm_result$preProcStandard,
