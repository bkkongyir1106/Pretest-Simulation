...
save.image(paste0("TwoSamplesExpectedPowerlossOR20240607*",".RData"))


# Save the results
save(nvec, power_t.test_par, power_perm.test_par, powerloss, prob.non.sig.SW.test_par, file = "TwoSamplesExpectedPowerLossOR20240607.RData")
