...
```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Simulation/EXPECTED POWER LOSS/ONE SAMPLE/OneSampleOverallPower20240607.RData")
#Probability of SW test
...
```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Simulation/EXPECTED POWER LOSS/ONE SAMPLE/ONESAMPLE_EXPECTED_TYPE1_ERROR.RData")
#Probability of SW test
nvec = nvec[-1]
data_prob_SW <-data.frame(prob.non.sig.SW.test_par)[-1,]
# power loss
...
```{r}
rm(list = ls())
load("/Users/benedictkongyir/Desktop/OSU/Research/Pretest-Simulation/Simulation/EXPECTED POWER LOSS/ONE SAMPLE/ONESAMPLE.OVERALL.TYPI.ERROR..RData")
#Probability of SW test
