...
# Generate data
set.seed(123)
normal <- generate_data(10, 10, "normal", "Normal")
stdnormal <- generate_data(10, 10, "Standard Normal", "Normal")
lognorma <- generate_data(10, 10,  "LogNormal", "Non_Normal")
chisq_data <- generate_data(10, 10, "Chi-Square", "Non_Normal")
exp_data <- generate_data(10, 10, "Exponential", "Non_Normal")
Weibull <- generate_data(10, 10, "Weibull", "Non_Normal")
Pareto <- generate_data(10, 10, "Pareto", "Non_Normal")
...
normal <- generate_data(10, 10, "normal", "Normal")
stdnormal <- generate_data(10, 10, "Standard Normal", "Normal")
lognormal <- generate_data(10, 10,  "LogNormal", "Non_Normal")
Uniform <- generate_data(10, 10, "Uniform", "Non_Normal")
Weibull <- generate_data(10, 10, "Weibull", "Non_Normal")

# Combine the validation data
validation_data <- rbind(stdnormal, lognormal)
