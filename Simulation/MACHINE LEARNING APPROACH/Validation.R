...
lognorma <- generate_data(300, 10, "LogNormal", "Non_Normal")
chisq_data <- generate_data(200, 10, "Chi-Square", "Non_Normal")
exp_data <- generate_data(300, 10, "Exponential", "Non_Normal")
Pareto <- generate_data(200, 10, "Pareto", "Non_Normal")
...
set.seed(123)
validation_normal <- generate_data(1000, 10, "normal", "Normal")
validation_gamma <- generate_data(1000, 10, "Gamma", "Non_Normal")
