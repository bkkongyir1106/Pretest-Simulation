...
title(main = "Type I Error Rate -Exponential...t.test")
...
Error.exp.t<- as.data.frame(pvalue)

#export data into excel
library("writexl")
write_xlsx(Error.exp.t,"D:/OSU/Research/Pval/New folder/Error_Exp.xlsx")

save.image(paste0("Error.exp.t",".RData"))
