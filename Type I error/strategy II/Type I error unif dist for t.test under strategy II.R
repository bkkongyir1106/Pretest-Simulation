...
pvalue
myplot<-plot(sample_size,pvalue[,1], type = "b", pch=24,lwd=3,ylim = c(0.00,0.25), 
             ylab = "Type I Error", xlab = "Sample Size")
title(main = "Type I Error Rate -unif_t_II.test")
...
library("writexl")
write_xlsx(error.unif_t_II, "D:/OSU/Research/Pval/strategy II/Error.unif.t_II.test.xlsx")

save.image(paste0("error.unif.t_II",".RData"))