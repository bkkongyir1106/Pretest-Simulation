...
title(main = "Type I Error Rate -exp.t_II.test")
...
library("writexl")
write_xlsx(error.exp_t_II, "D:/OSU/Research/Pval/strategy II/error.exp_t_II.xlsx")

save.image(paste0("error.exp_t_II",".RData"))