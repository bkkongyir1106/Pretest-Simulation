...
title(main = "Type I Error Rate -Exp_w.test")
...
library("writexl")
write_xlsx(error.exp_w_II, "D:/OSU/Research/Pval/strategy II/error.exp_w_II.xlsx")

save.image(paste0("error.exp_w_II","myplot",".RData"))