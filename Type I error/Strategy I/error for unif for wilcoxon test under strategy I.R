...
jpeg(file="error_unif_strategy I_w.jpeg")

myplot<-plot(sample_size,pvalue[,1], type = "l", pch=24,lwd=3,ylim = c(0.00,0.25), 
             ylab = "Type I Error", xlab = "Sample Size")
title(main = "Type I Error Rate for wilcoxon test for samples from unif dist under strategy I")
...
library("writexl")
write_xlsx(w, "D:/OSU/Research/Simulations/Type I error rate under strategy I/w")

save.image(paste0("error.unif_w_I",".RData"))