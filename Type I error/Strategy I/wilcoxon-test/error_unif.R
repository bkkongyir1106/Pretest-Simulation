...
title(main = "Type I Error Rate--strategy I -uniform...t.test")
...
Error_unif_t.test_I<- as.data.frame(error)

#export data into excel
library("writexl")
write_xlsx(Error_unif_t.test_I,"D:/OSU/Research_Fall2023/type I error/u test strategy I/Error_unif_t.test_I.xlsx")

save.image(paste0("Error_unif_t.test_I",".RData"))
